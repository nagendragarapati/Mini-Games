    ...
    <div className="main-nav">
      ...
      {!falseClicked && (
        <div className='scores-container'>
          <p className="text-emoji scorevalue">Score: <span className='score-emoji'>{score}</span></p>
          <p className="text-emoji">Top Score: <span className='score-emoji'>{TopScore}</span></p>
        </div>
      )}
    </div>
  )
