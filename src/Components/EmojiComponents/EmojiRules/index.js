        ...
        <div className='emoji-rules-main'>
            ...
            <div className='middle-main'>
                ...
                <div className='icon-sec'>
                    <img src='/Images/Group 7471emoji.png' alt="icon-emoji" className='emoji-rules-icon' />
                </div>
                ...
                <div className='rules-container'>
                    ...
                    <button type='button' className='emoji-start-play' onClick={()=>navigate("/emoji-game")}>Start Playing</button>
                    </div>
